...
func TestTimeFromName(t *testing.T) {
	...
	val := l.timeFromName("foo-2014-05-04T14-44-33.555.log", prefix, ext, ext)
	equals("2014-05-04T14-44-33.555", val, t)

	val = l.timeFromName("foo-2014-05-04T14-44-33.555", prefix, ext, ext)
	equals("", val, t)

	val = l.timeFromName("2014-05-04T14-44-33.555.log", prefix, ext, ext)
	equals("", val, t)

	val = l.timeFromName("foo.log", prefix, ext, ext)
	equals("", val, t)
}
