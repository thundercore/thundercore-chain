...
// SetVerboseWriter sets the writer which writes more verbose logs
// to another output if the logger exists.
func SetVerboseWriter(writer io.Writer) {
	verboseLogger = log.New(writer, "", flags)
}
