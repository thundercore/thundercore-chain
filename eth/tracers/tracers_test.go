...
// thunder_patch begin
var thunderConfig *params.ThunderConfig
...
func TestPrestateTracerCreate2(t *testing.T) {
	...
	*/
	...
	params.MainnetChainConfig.Thunder = params.ThunderConfigForTesting(common.Big0, "")
...
func TestCallTracer(t *testing.T) {
	...
	// thunder_patch begin
	// This test case sets gas limit in tx.Input which is generated by geth.
	// It's hard to modify so skip pala-r2.5 gas table bump here.
	thunderConfig = params.ThunderConfigForTesting(nil, "")
	thunderConfig.GasTable.SetTestValueAtSession("", 0)
	// thunder_patch end
	...
	for _, file := range files {
		...
		t.Run(camel(strings.TrimSuffix(strings.TrimPrefix(file.Name(), "call_tracer_"), ".json")), func(t *testing.T) {
			...
			// thunder_patch begin
			test.Genesis.Config.Thunder = thunderConfig
			signer := types.MakeSigner(test.Genesis.Config, new(big.Int).SetUint64(uint64(test.Context.Number)), 0)
